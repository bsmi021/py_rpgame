...
def get_att_event_time_tokens(att_event_time):
    "Output: att_year, att_month, att_day, att_hour, att_min, att_sec, att_ms, att_timestamp"
    ...
    att_timestamp = int(dt.timestamp() * 1000000)
    att_date = int(datetime.datetime.strptime('{}-{}-{}'.format(att_year, att_month, att_day), '%Y-%m-%d').timestamp())
    att_datetime = int(datetime.datetime.strptime('{}-{}-{} {}:{}:{}'.format(att_year, att_month, att_day,
                                                                             att_hour, att_min, att_sec)
...
# tests
dates = []
dates.append('2018-11-28 16:05:21.362799+00:00')
